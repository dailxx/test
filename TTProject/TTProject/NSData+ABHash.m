...
- (NSString *)ab_hmacStringUsingAlg:(CCHmacAlgorithm)alg withKey:(NSString *)key
{
    size_t size;
    switch (alg) {
...
- (NSData *)ab_hmacDataUsingAlg:(CCHmacAlgorithm)alg withKey:(NSData *)key {
    size_t size;
    switch (alg) {
        case kCCHmacAlgMD5: size = CC_MD5_DIGEST_LENGTH; break;
        case kCCHmacAlgSHA1: size = CC_SHA1_DIGEST_LENGTH; break;
...
{
    return [self ab_hmacStringUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSData *)ab_hmacMD5DataWithKey:(NSData *)key
{
    return [self ab_hmacDataUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSString *)ab_hmacSHA1StringWithKey:(NSString *)key
{
    return [self ab_hmacStringUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSData *)ab_hmacSHA1DataWithKey:(NSData *)key
{
    return [self ab_hmacDataUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSString *)ab_hmacSHA224StringWithKey:(NSString *)key
{
    return [self ab_hmacStringUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSData *)ab_hmacSHA224DataWithKey:(NSData *)key
{
    return [self ab_hmacDataUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSString *)ab_hmacSHA256StringWithKey:(NSString *)key
{
    return [self ab_hmacStringUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSData *)ab_hmacSHA256DataWithKey:(NSData *)key
{
    return [self ab_hmacDataUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSString *)ab_hmacSHA384StringWithKey:(NSString *)key
{
    return [self ab_hmacStringUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSData *)ab_hmacSHA384DataWithKey:(NSData *)key
{
    return [self ab_hmacDataUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSString *)ab_hmacSHA512StringWithKey:(NSString *)key
{
    return [self ab_hmacStringUsingAlg:kCCHmacAlgSHA512 withKey:key];
}

- (NSData *)ab_hmacSHA512DataWithKey:(NSData *)key
{
    return [self ab_hmacDataUsingAlg:kCCHmacAlgSHA512 withKey:key];
}
